...
public class SplitTransitionTests extends ShellTestCase {
    ...
    public void setup() {
        ...
        mSplitTransitionAnimations = spy(mSplitScreenTransitions.getSplitTransitionAnimations());
        mSplitScreenTransitions.setSplitTransitionAnimations(mSplitTransitionAnimations);
