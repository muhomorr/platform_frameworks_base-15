...
class LowLightClockDreamServiceTest : SysuiTestCase() {
    ...
    private val Kosmos.chargingStatusProvider by Kosmos.Fixture<ChargingStatusProvider> { mock() }
    private val Kosmos.displayController by Kosmos.Fixture<LowLightDisplayController> { mock() }
    private val Kosmos.lowLightTransitionCoordinator by
        Kosmos.Fixture<LowLightTransitionCoordinator> { mock() }
    private val Kosmos.textClock by Kosmos.Fixture<TextClock> { mock() }
    private val Kosmos.chargingStatusTextView by Kosmos.Fixture<TextView> { mock() }
    private val Kosmos.animationInAnimator by Kosmos.Fixture<Animator> { mock() }
    private val Kosmos.animationOutAnimator by Kosmos.Fixture<Animator> { mock() }
    ...
    private var Kosmos.underTest by
        Kosmos.Fixture {
    ...
    @Before
    fun setUp() {
        kosmos.dreamServiceDelegate.fake.apply {
    ...
    @Test
    fun testNotSetDbmStateWhenNoDisplayController() =
        kosmos.runTest {
            underTest =
                LowLightClockDreamServiceImpl(
                    chargingStatusProvider,
