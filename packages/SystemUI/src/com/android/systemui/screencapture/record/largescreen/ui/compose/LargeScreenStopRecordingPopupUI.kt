...
fun LargeScreenStopRecordingPopupUI(viewModel: LargeScreenStopRecordingPopupViewModel) {
    ...
    val alignment = if (StatusBarForDesktop.isEnabled) Alignment.End else Alignment.Start
        ...
        Column(
            ...
            modifier =
                Modifier.fillMaxSize()
                    .pointerInput(Unit) { detectTapGestures { viewModel.dismiss() } }
                    .windowInsetsPadding(
                    ...
                    .padding(
                        start = if (alignment == Alignment.Start) 20.dp else 0.dp,
                        end = if (alignment == Alignment.End) 80.dp else 0.dp,
                    ),
        ) {
            Surface(
