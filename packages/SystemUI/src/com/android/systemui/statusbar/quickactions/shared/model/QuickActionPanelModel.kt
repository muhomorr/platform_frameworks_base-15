...
/**
 * A Model representing the currently active quick action panel in the status bar.
 * QuickActionPanels are panels anchored to a specific QuickActionChip in the status bar.
 */
