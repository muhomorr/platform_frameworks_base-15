...
package com.android.systemui.statusbar.phone.ongoingcall.shared

import com.android.systemui.Flags
import com.android.systemui.flags.FlagToken
import com.android.systemui.flags.RefactorFlagUtils

/** Helper for reading or using the per display ongoing call status bar visibility flag state. */
@Suppress("NOTHING_TO_INLINE")
object PerDisplayOngoingCallStatusBarVisibility {
    /** The aconfig flag name */
    const val FLAG_NAME = Flags.FLAG_PER_DISPLAY_ONGOING_CALL_STATUS_BAR_VISIBILITY
    ...
    inline val isEnabled
        get() = Flags.perDisplayOngoingCallStatusBarVisibility()
