...
/** The core logic for the low-light clock dream. */
...
constructor(
    ...
    @Assisted private val dreamServiceDelegate: DreamServiceDelegate,
    ...
    fun onAttachedToWindow() {
        dreamServiceDelegate.isInteractive = false
        dreamServiceDelegate.isFullscreen = true
        dreamServiceDelegate.setContentView(R.layout.low_light_clock_dream)
        textClock = dreamServiceDelegate.findViewById(R.id.low_light_text_clock)!!
        chargingStatusTextView = dreamServiceDelegate.findViewById(R.id.charging_status_text_view)!!
    ...
    fun onDreamingStarted() {
        ...
        if (isDimBrightnessSupported) {
            ...
            dreamServiceDelegate.setScreenBrightness(0f)
        }
    }
    ...
    /** Factory for creating [LowLightClockDreamServiceImpl]. */
    @AssistedFactory
    interface Factory {
        /** Creates a [LowLightClockDreamServiceImpl]. */
        fun create(dreamServiceDelegate: DreamServiceDelegate): LowLightClockDreamServiceImpl
    }

    companion object {
        private const val TAG = "LowLightClockDreamSvcImpl"
    }
}
