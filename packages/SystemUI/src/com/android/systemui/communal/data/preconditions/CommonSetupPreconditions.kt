...
package com.android.systemui.communal.data.preconditions
...
@Inject
constructor(
    // TODO(b/475511781): Inject dependencies like KeyguardInteractor, ConnectivityRepository, etc.
) : CommonSetupPreconditions {
    /**
     * For now, this is hardcoded to `true` to unblock UI development.
     */
    override val allMet: Flow<Boolean> = flowOf(true)
}
