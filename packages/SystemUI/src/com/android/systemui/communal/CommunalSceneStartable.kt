                ...
                keyguardInteractor.isDreaming
                    ...
                    .collectLatest { (isDreaming, scene) ->
                        ...
                        if (scene.isCommunal() && isDreaming && timeoutJob == null) {
                            ...
                            // under the hub, wait for IS_DREAMING_NOT_DOZING_DELAY_MS and then
                            // close the hub. The delay is necessary so the
                            // KeyguardInteractor.isDreamingNotDozing flow passes through that same
                            // amount of delay and publishes a new value which is then picked up by
                            // the HomeSceneFamilyResolver such that the next call to
                            // SceneInteractor.changeScene(Home) will resolve "Home" to "Dream".
                            delay(KeyguardInteractor.IS_DREAMING_NOT_DOZING_DELAY_MS)
