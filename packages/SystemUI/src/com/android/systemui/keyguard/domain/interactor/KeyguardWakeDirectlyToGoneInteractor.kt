...
constructor(
    ...
    val canWakeDirectlyToGone =
        combine(
                ...
                val isKeyguardDisabledOrSuppressed = !keyguardEnabled || shouldSuppressKeyguard
                val isWakeAndDismiss =
                    BiometricUnlockMode.isWakeAndDismiss(biometricUnlockState.mode)

                val isDreamingAndDismissible =
                    currentScene == Scenes.Dream && deviceUnlockStatus?.isUnlocked == true

                isKeyguardDisabledOrSuppressed ||
                    isWakeAndDismiss ||
