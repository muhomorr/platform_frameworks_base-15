...
class UnvalidatedKeyParametersTest {

    @Test
    fun get_existingKey_returnsValue() {
        val params = UnvalidatedKeyParameters(mapOf("key1" to "value1"))
    ...
    fun isEmpty_whenEmpty_isTrue() {
        val params = UnvalidatedKeyParameters(emptyMap())
    ...
    fun toBundle_returnsCorrectBundle() {
        ...
        val params = UnvalidatedKeyParameters(map)
    ...
    fun toParametersString_multipleParams_returnsCorrectString() {
        val params = UnvalidatedKeyParameters(mapOf("key1" to "val1", "key2" to "val2"))
    ...
    fun toParametersString_paramWithSpecialChars_returnsCorrectString() {
        val params = UnvalidatedKeyParameters(
