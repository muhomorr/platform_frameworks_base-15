...
class ListSwitcherDialogFragment : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val layoutParams =
            itemListWrapper.layoutParams as androidx.constraintlayout.widget.ConstraintLayout.LayoutParams
        ...
        val dialogButton =
            view.findViewById<com.google.android.material.button.MaterialButton>(R.id.dialog_button)
        ...
        val spaceSize = context.resources.getDimensionPixelSize(com.android.settingslib.widget.theme.R.dimen.settingslib_expressive_space_extrasmall1)
