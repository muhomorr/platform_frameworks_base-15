...
bool ManifestFixer::BuildRules(xml::XmlActionExecutor* executor, IAaptContext* context) {
  ...
  manifest_action["uses-permission"]["specific-purpose"];
  ...
  manifest_action["uses-permission-sdk-23"]["specific-purpose"];
  ...
  manifest_action["permission"]["valid-specific-purpose"].Action(RequiredNameIsNotEmpty);
