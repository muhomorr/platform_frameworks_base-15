 ...
 * </code>. When <code>RELEASE_AIDL_USE_UNFROZEN</code> is set, this file is included and the
 * KeyMint v5 AIDL interface is used, which enables Tag::ML_DSA_VARIANT to be supported.
 *
 * @hide
 */
