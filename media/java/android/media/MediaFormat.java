...
import static android.media.codec.Flags.FLAG_XHE_AAC_ENCODER;
...
public final class MediaFormat {
    ...
    */
    ...
    /**
     * An optional key for selection of a live automatic loudness mode
     * for one-pass encoding with extended HE-AAC (MediaCodecInfo.CodecProfileLevel.AACObjectXHE).
     * <p>
     * The associated value is an integer and can be set to following values:
     * <table>
     * <tr><th>Value</th><th>Live automatic loudness Mode</th></tr>
     * <tr><td>0</td><td>default/general</td></tr>
     * <tr><td>1</td><td>aggressive</td></tr>
     * </table>
     * <p>
     * For user-generated content, the aggressive live automatic loudness mode should be used.
     * <p>
     * For professionally mixed content with known properties, the default/general live automatic
     * loudness mode should be used. This mode tries to preserve the content dynamics to the
     * maximum possible extent.
     * <p>
     * The default mode is 0 ("default").
     * For extended HE-AAC, live automatic loudness mode cannot be disabled by design.
     * <p>
     * This key is only used during encoding with extended HE-AAC.
     */
    @FlaggedApi(FLAG_XHE_AAC_ENCODER)
    public static final String KEY_AAC_LIVE_AUTOMATIC_LOUDNESS_MODE =
            "aac-live-automatic-loudness-mode";

    /**
     * An optional key for selecting the audio encoding mode.
     *
     * This allows for the first pass of a two-pass extended HE-AAC
     * (MediaCodecInfo.CodecProfileLevel.AACObjectXHE) encoding to measure loudness.
     * <p>
     * The associated value is an integer and can be set to following values:
     * <table>
     * <tr><th>Value</th><th>Audio Encoding Mode</th></tr>
     * <tr><td>0</td><td>default</td></tr>
     * <tr><td>1</td><td>measure loudness</td></tr>
     * </table>
     * <p>
     * Two-pass extended HE-AAC can provide a higher quality output by measuring the volume data
     * on the first pass and then passing it back to encoder for the second pass.
     * <p>
     * When encoding two-pass extended HE-AAC, please set KEY_AUDIO_ENCODING_MODE to 1 and encode.
     * Save the byte buffer and pass it to {@link #KEY_AAC_LOUDNESS_DATA} for the second pass.
     * <p>
     * The default mode is 0 ("default").
     * <p>
     * This key is only used during encoding with extended HE-AAC.
     */
    @FlaggedApi(FLAG_XHE_AAC_ENCODER)
    public static final String KEY_AUDIO_ENCODING_MODE =
            "audio-encoding-mode";

    /**
     * An optional key used for two-pass encoding with extended HE-AAC
     * (MediaCodecInfo.CodecProfileLevel.AACObjectXHE).
     * <p>
     * This key is used to hand over the loudness related metadata generated in the first
     * extended HE-AAC encoding pass, to the second extended HE-AAC encoding pass.
     * <p>
     * This data buffer varies in size and scales with the duration of the audio input
     * to the first encoding pass according to this equation:
     *    44 bytes + 40 bytes per second of audio input.
     * <p>
     * The associated value is a ByteBuffer in native byte order of the underlying platform
     * according to following format:
     *
     * <table border="1" width="90%" align="center" cellpadding="5">
     *     <tbody>
     *     <tr>
     *         <td>measureAnchorLoudness - int(32) </td>
     *         <td>Shall be set to a value of 0.</td>
     *     </tr>
     *     <tr>
     *         <td>loudness - float(32)</td>
     *         <td>The long-term loudness level in LKFS according to ITU-R BS.1770.</td>
     *     </tr>
     *     <tr>
     *         <td>samplePeak - float(32)</td>
     *         <td>The maximum sample amplitude in dBFS.</td>
     *     </tr>
     *     <tr>
     *         <td>loudnessRange - float(32)</td>
     *         <td>The Loudness Range in LU according to EBU Tech 3342.</td>
     *     </tr>
     *     <tr>
     *         <td>nChannels - int(32)</td>
     *         <td>The number of channels.</td>
     *     </tr>
     *     <tr>
     *         <td>audioBlockLength - int(32)</td>
     *         <td>The audio block length in samples corresponding to one entry in the
     *             instantaneousLoudness array.</td>
     *     </tr>
     *     <tr>
     *         <td>sampleRate - int(32)</td>
     *         <td>The sample rate in samples per second.</td>
     *     </tr>
     *     <tr>
     *         <td>nSamplesInLoudnessMeter - int(32)</td>
     *         <td>The number of samples not represented in the instantaneousLoudness array.</td>
     *     </tr>
     *     <tr>
     *         <td></td>
     *         <td>item length (in samples per channel) = audioBlocksProcessed *
     *              audioBlockLength + nSamplesInLoudnessMeter / nChannels</td>
     *     </tr>
     *     <tr>
     *         <td>audioBlocksProcessed - int(32)</td>
     *         <td>The number of audio blocks represented in the instantaneousLoudness array.</td>
     *     </tr>
     *     <tr>
     *         <td>minRequiredSamplesProcessed - int(32)</td>
     *         <td>A flag which indicates that the minimum number of samples
     *             has been processed. If this flag is set to 0, the ByteBuffer is invalid.</td>
     *     </tr>
     *     <tr>
     *         <td>instantaneousLoudness - audioBlocksProcessed elements of type float(32)</td>
     *         <td>An array of instantaneous loudness values (in LKFS) of length
     *             audioBlocksProcessed.</td>
     *     </tr>
     *     <tr>
     *         <td>checkSum - 4 elements of type unsigned char(8)</td>
     *         <td>Hash value for verification of the ByteBuffer integrity.</td>
     *     </tr>
     * </table>
     */
    @FlaggedApi(FLAG_XHE_AAC_ENCODER)
    ...
    /**
     * An optional key for setting a stream ID for an stream.
     *
     * <p>
     * The associated value is an integer as the stream ID.
     * <p>
     * For encoding with extended HE-AAC (MediaCodecInfo.CodecProfileLevel.AACObjectXHE), when it
     * is not specified, a random number generator produces an integer and writes it to the
     * bitstream.
     */
    @FlaggedApi(FLAG_XHE_AAC_ENCODER)
    public static final String KEY_STREAM_ID = "stream-id";

    /**
     * An optional key for specifying a list of Random Access Point (RAP)
     * positions in samples in the extended HE-AAC bitstream
     * (MediaCodecInfo.CodecProfileLevel.AACObjectXHE).
     * <p>
     * The associated value is a byte buffer of integers containing the
     * intervals in milliseconds. Each RAP position value specified by the user
     * will be readjusted internally to the next rounded multiple of 4096 samples.
     * <p>
     * The first encoded frame will always be a RAP, thus the first interval in the
     * associated list specifies the interval between the first and second RAP.
     * <p>
     * If the list of RAP intervals specified does not cover the full audio stream,
     * it will wrap to the start and thus be repeated until the end of the encoded
     * audio stream.
     * <p>
     * For example, specifying a RAP interval list of [896, 2432] milliseconds at 48kHz
     * and with 1024-sample frames will result in the following (1-based) encoded frames
     * to be RAPs: 1, 45, 161, 205, 321, …
     * <p class="note">
     * For example, specifying a constant RAP interval of 896ms at 48kHz
     * and with 1024-sample frames will result in the following (1-based) encoded frames
     * to be RAPs: 1, 45, 89, 133, 177, …
     * <p>
     * Below is an example of how this is set for a MediaFormat.
     *  <pre class=prettyprint>
     *  ByteBuffer rapIntervals
     *          = ByteBuffer.allocateDirect(2 * Integer.BYTES).order(ByteOrder.nativeOrder());
     *  rapIntervals.asIntBuffer().put(new int[] {896, 2432});
     *  format.setByteBuffer(MediaFormat.KEY_AAC_RAP_INTERVALS, rapIntervals);
     *  </pre>
     *
