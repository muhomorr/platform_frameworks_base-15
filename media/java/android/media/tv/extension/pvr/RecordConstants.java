...
/**
 * Constant definition for PVR extension package.
 *
 * @hide
 */
final class RecordConstants {
    @IntDef({
            ...
            DELETION_RESULT_FAILED_REASON_UNKNOWN,
            DELETION_RESULT_FAILED_INVALID_CONTENTS_URI,
            DELETION_RESULT_FAILED_CONTENT_IS_BUSY
    })
