...
public class PrimitiveDelayAdapterTest {
    ...
    public void testPrimitiveWithRelativeDelay_afterMixedPwles_uses3rdSegmentStartTimeForDelay() {
        List<VibrationEffectSegment> segments = new ArrayList<>(Arrays.asList(
                ...
                new BasicPwleSegment(1f, 0.5f, 1f, 0.5f, 50, /* isFirstSegment= */ false),
                new PrimitiveSegment(PRIMITIVE_CLICK, 1f, 160, DELAY_TYPE_RELATIVE_START_OFFSET)));
    ...
    public void testPrimitiveWithRelativeDelay_afterBasicPwle_usesSegmentStartTimeForDelay() {
        List<VibrationEffectSegment> segments = new ArrayList<>(Arrays.asList(
                new BasicPwleSegment(0f, 1f, 0f, 1f, 100, /* isFirstSegment= */ true),
                new BasicPwleSegment(1f, 0.5f, 1f, 0.5f, 50, /* isFirstSegment= */ false),
                new PrimitiveSegment(PRIMITIVE_CLICK, 1f, 150, DELAY_TYPE_RELATIVE_START_OFFSET)));
    ...
    public void
        ...
        List<VibrationEffectSegment> segments = new ArrayList<>(Arrays.asList(
                new BasicPwleSegment(0f, 1f, 0f, 1f, 100, /* isFirstSegment= */ true),
                new BasicPwleSegment(1f, 0.5f, 1f, 0.5f, 50, /* isFirstSegment= */ false),
                new PrimitiveSegment(PRIMITIVE_CLICK, 1f, 140, DELAY_TYPE_RELATIVE_START_OFFSET)));
    ...
    public void
        ...
        List<VibrationEffectSegment> segments = new ArrayList<>(Arrays.asList(
                ...
                new PwleSegment(1f, 0f, 150f, 100f, 1000, /* isFirstSegment= */ false),
                new PrimitiveSegment(PRIMITIVE_CLICK, 1f, 3010, DELAY_TYPE_RELATIVE_START_OFFSET)));
    ...
    public void testPrimitiveAfterPwlesWithRelativeDelay_flagDisabled_pauseAdaptionUnchanged() {
        ...
        List<VibrationEffectSegment> expectedSegments = new ArrayList<>(Arrays.asList(
                new PwleSegment(0f, 1f, 100f, 150f, 2000, /* isFirstSegment= */ true),
                new PwleSegment(1f, 0f, 150f, 100f, 1000, /* isFirstSegment= */ false),
                new PrimitiveSegment(PRIMITIVE_CLICK, 1f, 2010, DELAY_TYPE_PAUSE)));
    ...
    public void
        ...
        List<VibrationEffectSegment> segments = new ArrayList<>(Arrays.asList(
                new PwleSegment(0f, 1f, 100f, 150f, 2000, /* isFirstSegment= */ true),
                new PwleSegment(1f, 0f, 150f, 100f, 1000, /* isFirstSegment= */ false),
                new PrimitiveSegment(PRIMITIVE_CLICK, 1f, 2900, DELAY_TYPE_RELATIVE_START_OFFSET)));
