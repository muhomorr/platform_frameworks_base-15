...
public class ParticlesCompare extends PaintOperation implements VariableSupport, Container {
    ...
    public ParticlesCompare(int id,
                            ...
                            float min,
                            float max,
                            @Nullable float [] expression,
                            @Nullable float [][] result1,
    ...
    public static void apply(
            ...
            float min,
            float max,
            @Nullable float [] compare,
            @Nullable float [][] equations1,
            @Nullable float [][] equations2
    ) {
    ...
    private static void writeFloats(@NonNull WireBuffer buffer, @Nullable float [] values) {
        if (values == null) {
            buffer.writeInt(0);
            return;
        }
