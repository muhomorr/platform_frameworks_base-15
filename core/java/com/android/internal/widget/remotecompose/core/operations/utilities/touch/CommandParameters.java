...
public class CommandParameters {
     ...
     * @param value  the value of the parameter
     */
    public void write(@NonNull WireBuffer buffer, byte id, @NonNull float [] value) {
        Param param = mParams[0xFF & id];
     ...
     * @param value  the value of the parameter
     */
    public void write(@NonNull WireBuffer buffer, byte id, @NonNull int [] value) {
        Param param = mParams[0xFF & id];
    ...
    public interface Callback {
         ...
         * @param value the value of the parameter
         */
        void value(int id, @NonNull int [] value);
         ...
         * @param value the value of the parameter
         */
        void value(int id, @NonNull float [] value);
    }
